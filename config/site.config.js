...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'mltbnew@zjj78.onmicrosoft.com',
  ...
  links: [
    {
      name: 'Telegram',
      link: 'https://telegram.me/isaimini_updates',
    },
  ],
